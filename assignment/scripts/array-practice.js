...
let favoriteFoods = ['mango', 'curry', 'ice cream', 'fries'];

// 1.b. TODO: Log your array of foods to the console with a message, similar
//      to the example above
//Example: Array of favorite foods
...
console.log('Number of favorite foods are:', favoriteFoods.length);
...
console.log('Last animal is',animalArray.length); // REVISIT this one
...
console.log('The favoite foods are now', favoriteFoods);
...
favoriteFoods.unshift('persimmon');
